...
프로젝트 소개
-
  + "모두를 위한 접근성과 맞춤형 여행 경험 제공"을 주제로 사용자들에게 쉽고 직관적인 인터페이스(UI)를 제공하고 여행지 선택을 도와주는 웹 애플리케이션을 기획했습니다
...
## 🖥 담당한 기능
![ERD](https://github.com/iseuljang/trip_first_teamproject/assets/173334655/2ecb887d-4005-41fd-bcdc-c08d755b3c8f)
...
![키오스크](https://github.com/iseuljang/trip_first_teamproject/assets/173334655/9468be39-2d67-45f3-a188-55f967e39601)
- **키오스크 기능**
